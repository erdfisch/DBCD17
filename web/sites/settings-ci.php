...
$settings['container_yamls'][] = $app_root . '/sites/services-ci.yml';
 ...
 * during the same request.
 *
 * One example of the simplest connection array is shown below.
 *
 * @code
 * $databases['default']['default'] = array (
 *   'database' => 'databasename',
...
$databases['default']['default'] = [
  'database' => 'ci',
  'username' => 'root',
  'host' => 'docker.erdfisch.de-erdfisch-mysql',
  'namespace' => 'Drupal\Core\Database\Driver\mysql',
  'driver' => 'mysql',
];

$settings['hash_salt'] = 'd9Qe2SCCSXa4eck475C14lXi4voh5R7d-6TVgC5UgPiXVN5eHwmuJbGwgMyFYhIqhGdfO4gY2A';
